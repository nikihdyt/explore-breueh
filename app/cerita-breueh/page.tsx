                  ...
                  <div className="flex flex-wrap items-center">
                    <div className="mb-5 mr-10 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="mb-1 text-base font-medium text-body-color">
                          Oleh <span>{blogData[blogData.length - 1].author.name}</span>
                        </span>
                      </div>
                    </div>
                    <div className="mb-5 flex items-center">
                      <p className="mr-5 flex items-center text-base font-medium text-body-color">
                        ...
                        {blogData[blogData.length - 1].publishDate}
                      </p>
                    </div>
                  </div>
                  <div className="mb-5">
                  {blogData[blogData.length - 1]?.tags?.map((tag, tagIndex) => (
                      <a
                        key={tagIndex}
                        href="#0"
              ...
              <div className="shadow-three dark:bg-black mb-10 rounded-sm bg-white dark:shadow-none">
                ...
                {blogData.map((blog, index) => (
                    blog.tags.map((tag, tagIndex) => (
                      <TagButton key={`${index}-${tagIndex}`} text={tag} />
                      ))
                    ))}
                </div>
              </div>
